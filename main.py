...
contactEnergy = [{"Type1":"Medium", "Type2":"Medium", "Value": 0.0},
                {"Type1":"Medium", "Type2":"Cancer", "Value": 10.0},
...
actinParams = [{"MembraneMT1": 0, "LambdaMT1": 300.0}]


mo.cpm(pottsElements, cellArr, contactEnergy, camStruct, volInit, surfInit, actinParams, saveImages)
